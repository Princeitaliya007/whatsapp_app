                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                TextButton(
                                  onPressed: () {},
                                  child:  const Icon(Icons.emoji_emotions_outlined, color: Colors.black45,
                                    size: 30,),
                                ...
                                Container(
                                 ...
                                 Spacer(),
                                 const Icon(Icons.camera_alt,size: 22,color: Colors.black45,),
                                const SizedBox(width: 10),
                                 const Icon(Icons.mic,size: 22,color: Colors.black45,),
                                const SizedBox(width: 10),
                              ],
                            ),
                          ),
